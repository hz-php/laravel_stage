...
<div
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        $news_json = $response->getBody()->getContents();
        $news_full = json_decode($news_json, true);
        //Формирую массив для вывода на странице и дальнейшего сохранения в local storage
        foreach ($news_full['results'] as $result) {
            $news_fix[] = [
                "title" => $result['title'],
